...
# installed.
TCL_PREFIX='D:/Final_Project/Deep_Research_Agent/.searchvnv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Final_Project/Deep_Research_Agent/.searchvnv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Final_Project/Deep_Research_Agent/.searchvnv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Final_Project/Deep_Research_Agent/.searchvnv\Library\include'
...
TCL_PACKAGE_PATH='D:/Final_Project/Deep_Research_Agent/.searchvnv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Final_Project/Deep_Research_Agent/.searchvnv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Final_Project/Deep_Research_Agent/.searchvnv\Library\lib\tclstub86.lib'
